...
const EditLostItemPage: React.FC = () => {
  ...
  if (!item) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 text-center">
        ...
        <Button onClick={() => navigate('/my-items')}>{t('items.backToMyItems')}</Button>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">{t('items.editLostItem')}</h1>
        <p className="text-gray-600">{t('items.editLostSubtitle')}</p>
      </div>
      {item.status !== 'ACTIVE' && (
      ...
      <form onSubmit={handleSubmit}>
        <Card className="p-6 mb-6">
          ...
          <div className="mb-6">
            <Textarea
              label={t("items.locationDetailsLabel")}
